  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="relative z-10">
        {/* Header (shared styles with homepage) */}
        <header className="sticky top-0 z-40 w-full border-b bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          <div className="container mx-auto flex h-14 items-center justify-between px-4">
            ...
            <nav aria-label="Primary navigation" className="hidden md:flex items-center space-x-6">
              ...
              <Link href="/#getting-started" className="relative inline-flex items-center pb-3 text-sm transition-colors hover:text-primary after:absolute after:left-0 after:bottom-0 after:h-0.5 after:w-full after:bg-primary after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 after:origin-left">Get Started</Link>
          ...
          <div className="container mx-auto px-4 py-3 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <Button asChild size="sm">
                <a href="mailto:cming.xu@gmail.com?subject=DeepSeek-OCR%20Sales" aria-label="Contact sales via email">Contact Sales</a>
              </Button>
              <Button asChild size="sm" variant="outline">
                <a href="mailto:cming.xu@gmail.com?subject=DeepSeek-OCR%20Urgent%20Access" aria-label="Email us for urgent access">Urgent? Email Us</a>
              </Button>
            </div>
          </div>
        </div>
        ...
        {/* Footer (simplified to match homepage sections) */}
          ...
          <div className="container mx-auto px-4 py-12">
            <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-5">
              ...
              <div>
                ...
                <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                  <li><a href="#" className="hover:text-foreground">Tool 1</a></li>
                  <li><a href="#" className="hover:text-foreground">Tool 2</a></li>
                  <li><a href="#" className="hover:text-foreground">Tool 3</a></li>
                  <li><a href="#" className="hover:text-foreground">Tool 4</a></li>
                </ul>
              </div>
            </div>
            <p className="mt-8 text-xs text-muted-foreground">This site is not affiliated with DeepSeek.com.</p>
          </div>
        </footer>
      </div>
    </div>
